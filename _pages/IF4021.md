...
> Skala penilaian mengacu kepada [Dokumentasi Penjaminan Mutu ITERA](https://penjamu.itera.ac.id/jaminan_mutu/sistem_dokumentasi)
...
| ----- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| 1     | 1     | Course Logistics<br>Introduction to Multimedia and Concepts                                                                                                                                                                                                                                                                                             | [1. Reflection]()<br> [2. Course Contract](https://forms.gle/qW7345Pw34xmRqPv5) | [IDE Setup](/course/env-install)                                                            |
| 2,3   | 1,2,3 | Audio Processing <br> Check [*Detailed lesson plan*](/course/if4021/lessonplan)                                                                                                                                                                                                                                                                         | [H.O.1 Report]()<br>Deadline: xx/xx                                             | [1. What is fourier transform](https://youtu.be/spUNpyF58BY?si=_qEShXtuyEJSJTWH)<br>[2. What is sound?](https://www.youtube.com/watch?v=24yESm63tSY) |
| 4,5   | 1,2,3 | Image Processing <br> Check [*Detailed lesson plan*](/course/if4021/lessonplan)                                                                                                                                                                                                                                                                         |                                                                                 | [Youtube](https://youtu.be/Kv1Hiv3ox8I?si=TxJPsg0J46GZ_tbL) |
| 6,7   | 1,2,3 | Video Processing <br> Check [*Detailed lesson plan*](/course/if4021/lessonplan)                                                                                                                                                                                                                                                                         | [H.O.2 Report]()<br>Deadline: xx/xx                                             |                                                             |
